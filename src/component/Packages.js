...
export default function Packages() {
  ...
  const fetchUserInfo = async()=>{
    const res = await baseApi.get("/user/info",{
  ...
  return (
    ...
    <div id='wedding-packages-list'>
      ...
      <div id='custom-wedding-list'>
        ...
        <button type='submit'><Link to ="/packages/custom/wedding">Customize Now</Link></button>
      </div>
      <div id='custom-event-list'>
        ...
        <button type='submit'><Link to ="/packages/custom/events">Customize Now</Link></button>
        </div>
      </div>
    </div>
  )
